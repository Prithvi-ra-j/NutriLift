...
export function ExerciseCard({
  exercise, exerciseType, totalVolume, estimated1RM,
  progressionMessage, previousPerformance, onEdit, onSwap, onDelete, children,
}: ExerciseCardProps) {
  return (
    <Card>
      <View style={{ flexDirection: "row", justifyContent: "space-between", alignItems: "flex-start", marginBottom: 10 }}>
        ...
        <View style={{ alignItems: "flex-end", gap: 4, marginLeft: 10 }}>
          ...
          <View style={{ flexDirection: "row", gap: 2 }}>
            <PressableScale onPress={onEdit} accessibilityRole="button" accessibilityLabel={"Edit " + exercise.exercise_name} style={{ width: 40, height: 40, alignItems: "center", justifyContent: "center" }}>
      ...
      {progressionMessage ? (
        <View style={{ backgroundColor: M3.colors.warningContainer, borderRadius: M3.shape.small, padding: 8, marginBottom: 8, flexDirection: "row", gap: 6 }}>
